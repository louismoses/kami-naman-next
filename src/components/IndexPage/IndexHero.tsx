...
export default function IndexHero() {
  return (
    <div
      className="text-white min-h-[100vh] w-full bg-cover bg-no-repeat bg-center flex justify-center  items-center relative"
    ...
    >
      <div className="max-w-[1224px] flex w-full">
        <ScrollDown80>
          <div className="p-8 mb-10 max-w-[748px]">
            ...
            <h3 className="text-md md:text-2xl font-black">
              (Philstar Global, 2023)
            </h3>
          </div>
        </ScrollDown80>
      </div>
      <div className=" absolute bottom-8 p-8">
        <ScrollUp40>
          <span className=" text-md md:text-2xl font-medium italic kn-text-yellow">
